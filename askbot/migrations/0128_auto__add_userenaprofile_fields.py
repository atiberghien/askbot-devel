...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AskbotProfile.mugshot'
        db.add_column('askbot_askbotprofile', 'mugshot',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'AskbotProfile.privacy'
        db.add_column('askbot_askbotprofile', 'privacy',
                      self.gf('django.db.models.fields.CharField')(default='registered', max_length=15),
                      keep_default=False)

        # Adding field 'AskbotProfile.language'
        db.add_column('askbot_askbotprofile', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AskbotProfile.mugshot'
        db.delete_column('askbot_askbotprofile', 'mugshot')

        # Deleting field 'AskbotProfile.privacy'
        db.delete_column('askbot_askbotprofile', 'privacy')

        # Deleting field 'AskbotProfile.language'
        db.delete_column('askbot_askbotprofile', 'language')
