...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('auth_user', 'avatar_type')
        db.delete_column('auth_user', 'bronze')
        db.delete_column('auth_user', 'consecutive_days_visit_count')
        db.delete_column('auth_user', 'country')
        db.delete_column('auth_user', 'date_of_birth')
        db.delete_column('auth_user', 'display_tag_filter_strategy')
        db.delete_column('auth_user', 'email_isvalid')
        db.delete_column('auth_user', 'email_key')
        db.delete_column('auth_user', 'email_signature')
        db.delete_column('auth_user', 'email_tag_filter_strategy')
        ...
        db.delete_column('auth_user', 'show_country')
        db.delete_column('auth_user', 'show_marked_tags')
        db.delete_column('auth_user', 'silver')
        db.delete_column('auth_user', 'status')
