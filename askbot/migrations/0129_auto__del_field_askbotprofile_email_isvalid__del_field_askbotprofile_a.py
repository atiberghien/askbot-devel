...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AskbotProfile.email_isvalid'
        db.delete_column('askbot_askbotprofile', 'email_isvalid')

        # Deleting field 'AskbotProfile.avatar_type'
        db.delete_column('askbot_askbotprofile', 'avatar_type')

        # Deleting field 'AskbotProfile.email_key'
        db.delete_column('askbot_askbotprofile', 'email_key')

        # Deleting field 'AskbotProfile.gravatar'
        db.delete_column('askbot_askbotprofile', 'gravatar')


    def backwards(self, orm):
        # Adding field 'AskbotProfile.email_isvalid'
        db.add_column('askbot_askbotprofile', 'email_isvalid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AskbotProfile.avatar_type'
        db.add_column('askbot_askbotprofile', 'avatar_type',
                      self.gf('django.db.models.fields.CharField')(default='n', max_length=1),
                      keep_default=False)

        # Adding field 'AskbotProfile.email_key'
        db.add_column('askbot_askbotprofile', 'email_key',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'AskbotProfile.gravatar'
        raise RuntimeError("Cannot reverse this migration. 'AskbotProfile.gravatar' and its values cannot be restored.")
    ...
    models = {
        ...
        'askbot.askbotprofile': {
            'Meta': {'object_name': 'AskbotProfile'},
