...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AskbotProfile'
        db.create_table('askbot_askbotprofile', (
        ...
        db.send_create_signal('askbot', ['AskbotProfile'])


    def backwards(self, orm):
        # Deleting model 'AskbotProfile'
        db.delete_table('askbot_askbotprofile')
